...
function validarCampo(input, errorElement, tipo = "float", min = 1, max = 300) {
...
pesoInput.addEventListener("input", () => validarCampo(pesoInput, pesoError));
...
form.addEventListener("submit", function (event) {
    ...
    const validAltura = validarCampo(alturaInput, alturaError, "int", 50, 300);
    ...
    const grasa = calcularGrasaCorporal(altura, cuello, cintura, cadera, sexo);
