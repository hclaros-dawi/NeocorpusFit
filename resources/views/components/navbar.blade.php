<header class="header bg-black py-3">
    <div class="container d-flex flex-column flex-lg-row justify-content-between align-items-center">
        <a href="{{ route('home') }}" class="header__brand mx-auto mb-3 mb-lg-0">
        ...
        <nav class="navbar navbar-expand-lg header__nav">
            <div class="container-fluid px-0">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="mainNav">
                    <ul class="navbar-nav mb-2 mb-lg-0 header__menu">
                        ...
                        <li class="nav-item dropdown header__item">
                            <a class="nav-link dropdown-toggle text-white" href="#" id="suplementoDropdown"
                                role="button" data-bs-toggle="dropdown" aria-expanded="false">Suplementos</a>
                            <ul class="dropdown-menu header__dropdown" aria-labelledby="suplementoDropdown">
                                <li>
                                    <a class="dropdown-item header__highlight"
                                        href="{{ route('pages.suplementos.index') }}">Suplementos</a>
                                </li>
                                <li>
                        ...
                        <li class="nav-item dropdown header__item">
                            <a class="nav-link dropdown-toggle text-white" href="#" id="canastasDropdown"
                                role="button" data-bs-toggle="dropdown" aria-expanded="false">Canastas</a>
                            <ul class="dropdown-menu header__dropdown" aria-labelledby="canastasDropdown">
                                <li>
                                    <a class="dropdown-item header__highlight"
                                        href="{{ route('pages.canastas.index') }}">Canastas</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider bg-white">
                                </li>
                        ...
                        <li class="nav-item dropdown header__item">
                            ...
                            <ul class="dropdown-menu header__dropdown" aria-labelledby="menusDropdown">
                                <li>
                                    <a class="dropdown-item header__highlight"
                                        href="{{ route('pages.menus.index') }}">Menús</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider bg-white">
                                </li>
                        ...
                        <li class="nav-item dropdown header__item">
                            ...
                            <ul class="dropdown-menu header__dropdown" aria-labelledby="calculadorasDropdown">
                                <li>
                                    <a class="dropdown-item header__highlight"
                                        href="{{ route('pages.calculadoras.index') }}">Calculadoras</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider bg-white">
                                </li>
