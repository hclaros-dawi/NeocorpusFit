...
<body class="bg-dark-gray home-page">
    ...
    <section class="hero-section position-relative">
        ...
        <div
            ...
            <p class="lead bg-dark bg-opacity-75 p-3 p-md-4 rounded mt-3 mt-md-4">
                    ...
                    <div class="card-feature card-feature-section-1">
                        <div class="card-feature__body">
                            <img src="https://live.staticflickr.com/65535/54491969023_3439ea1ff1_s.jpg"
                                alt="Suplementos" class="card-feature__image mx-auto d-block" />
                            <h3 class="card-feature__title">SUPLEMENTOS</h3>
                            <p class="card-feature__text">
                                Descubre los tipos de suplementos y cómo usarlos
                            </p>
                            <a href="{{ route('pages.suplementos.index') }}" class="card-feature__button btn btn-sm">Ver
                                Más</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-feature card-feature-section-1">
                        <div class="card-feature__body">
                            <img src="https://live.staticflickr.com/65535/54492043290_fabccea76f_s.jpg"
                                alt="Calculadoras" class="card-feature__image mx-auto d-block" />
                            <h3 class="card-feature__title">CALCULADORAS</h3>
                            <p class="card-feature__text">
                                Empieza el cambio con datos. Calcula proteína, creatina, grasa, IMC y Harris-Benedict
                            </p>
                            <a href="{{ route('pages.calculadoras.index') }}"
                                class="card-feature__button btn btn-sm">Ver Más</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card-feature card-feature-section-2">
                        <div class="card-feature__body">
                            <h3 class="custom-heading d-flex align-items-center justify-content-center gap-2">
                                <img src="https://live.staticflickr.com/65535/54493455850_423ca23aa9_s.jpg"
                                    alt="icono-idea" class="icon-inline" /> RECETAS
                            </h3>
                    ...
                    <div class="card-feature card-feature-section-2">
                        <div class="card-feature__body">
                            <h3 class="custom-heading">
                                <img src="https://live.staticflickr.com/65535/54493455850_423ca23aa9_s.jpg"
                                    alt="icono-idea" class="icon-inline" /> MENÚS
                            </h3>
                ...
                <div class="col-md-4">
                    <div class="card-feature card-feature-section-2">
                        <div class="card-feature__body">
                            <h3 class="custom-heading">
                                <img src="https://live.staticflickr.com/65535/54493455850_423ca23aa9_s.jpg"
                                    alt="icono-idea" class="icon-inline" /> CANASTAS
                            </h3>
